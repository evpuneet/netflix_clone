...
export default function Productdeatil() {
      ...
      useEffect(()=>{
        ...
        .then((res)=>res.data)
        .then((finalres)=>{setPDetails(finalres)})
      })
        ...
        <div className="pt-6">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              <h2 className="sr-only">pDetails information</h2>
              <p className="text-3xl tracking-tight text-gray-900">{pDetails.price}</p>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <p className="text-base text-gray-900">{pDetails.availabilityStatus}</p>
                </div>
              </div>
              <div className="mt-10">
